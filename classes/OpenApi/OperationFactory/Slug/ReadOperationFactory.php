...
use Opencontent\OpenApi\OperationFactory\ContentObject\ReadOperationFactory as ReadOperationFactoryBase;
use Opencontent\OpenApi\SchemaBuilder\ReferenceSchema;

class ReadOperationFactory extends ReadOperationFactoryBase
{
    private $pageLabel;
