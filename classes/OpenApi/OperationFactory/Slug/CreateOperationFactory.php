...
use Opencontent\OpenApi\OperationFactory\ContentObject\CreateOperationFactory as CreateOperationFactoryBase;
use Opencontent\OpenApi\SchemaBuilder\ReferenceSchema;

class CreateOperationFactory extends CreateOperationFactoryBase
{
    private $pageLabel;
