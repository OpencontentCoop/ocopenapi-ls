...
use Opencontent\OpenApi\OperationFactory\ContentObject\DeleteOperationFactory as DeleteOperationFactoryBase;
use Opencontent\OpenApi\SchemaBuilder\ReferenceSchema;

class DeleteOperationFactory extends DeleteOperationFactoryBase
{
    private $pageLabel;
